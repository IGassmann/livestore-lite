...
Historical generator helpers used relative imports into materialized repos
rather than `#mr/livestore/...`; that resolver form is scoped to the file's own
megarepo root and fails for nested cross-repo composition.
