...
export default defineConfig({
  run: {
    ...
    tasks: {
      'ci:lint': {
        command: 'bash scripts/ci-vite-check.sh',
      ...
      'ci:type-check': {
        command: 'bash scripts/ci-vite-type-check.sh',
      ...
      'ci:docs:astro': {
        // Deployment is a separate uncached step. Remove its per-job OIDC
        // credentials from the build process so they cannot affect or enter the
        // cached result.
        command:
